...
import mImg from '../assets/masterMind.png'
        ...
        <a href="#" className="flex flex-col items-center bg-white border rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
          ...
          <a href="#" className="flex flex-col items-center bg-white border rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <ol className='list-disc'>
                ...
                <li className="mb-2 font-normal text-gray-700 dark:text-gray-400">Création d'un Jeu Master Mind en Python POO et son interface graphique en Tkinter</li>
                <li className="mb-2 font-normal text-gray-700 dark:text-gray-400">Technologies utilisées: Python</li>
              </ol>
            </div>
          </a>
