...
const Footer = () => {
        ...
        <div className="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    ...
                    <li>
                        <a href="https://www.manypixels.co/gallery" className="hover:underline">Many pixels</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li>
                        <a href="https://github.com/BasmaKasmi" className="hover:underline ">Github</a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/in/basma-kasmi-38aba923b/" className="hover:underline">LinkedIn</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.instagram.com/itsbasmawhat/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://github.com/BasmaKasmi" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
