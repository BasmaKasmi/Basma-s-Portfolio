  ...
  return (
    <div name='Projets' className='w-full text-white my-24'>
      ...
      <div className='max-w-[1240px] mx-auto py-2 '>
        ...
        <a href="https://github.com/BasmaKasmi/my-API" className="flex flex-col items-center bg-white border rounded-lg  hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 shadow-md md:flex-row md:max-w-xl">
          ...
          <a href="https://github.com/BasmaKasmi/Code-Camp-etna" className="flex flex-col items-center bg-white border rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
          ...
          <a href="https://github.com/BasmaKasmi/The-Hyrule-castle" className="flex flex-col items-center bg-white border rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
          ...
          <a href="https://github.com/BasmaKasmi/D-fi-ETNA" className="flex flex-col items-center bg-white border rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
